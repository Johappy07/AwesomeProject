...
import { SafeAreaView, Text, View, ScrollView, TextInput, Button, StyleSheet } from 'react-native';


const Createdata = () => {

    const jsonUrl = 'http://192.168.27.112:3000/mahasiswa'; //api yang digunakan emulator untuk mengakses localhost komputer
    ...
    const submit = () => {
        ...
        fetch('http://192.168.27.112:3000/mahasiswa', {
          method: 'POST',
          headers: {
